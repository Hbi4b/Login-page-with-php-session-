    ...
    <div class="d-flex align-items-center min-vh-100 bg-dark">
        <div class="container d-flex justify-content-center">
            <form method="post" class="bg-light px-5 py-4 rounded-3 col-md-6 col-lg-5 col-xl-4">
                ...
                <div class="mb-3">
                    <a href="register.php" class="text-decoration-none" style="font-size: 12px;">ليس لديك حساب (إنشاء حساب) ؟</a>
                </div>
                <button type="submit" name="submit" class="btn btn-success w-75 d-block m-auto">تسجيل دخول</button>
            </form>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content bg-danger bg-gradient">
                ...
                <div class="modal-body text-warning">
                    <h4 class="text-center p-3">فشل تسجيل الدخول الرجاء المحاولة مرة أخرى</h4>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-dark w-75 d-block m-auto" data-bs-dismis="modal">إغلاق</button>
                </div>
            </div>
        </div>
    </div>
